...
ifneq ($(DEFAULT_SIGNER_VAULT_JWT_LOGIN_URL),)
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/signer.DEFAULT_SIGNER_VAULT_JWT_LOGIN_URL=$(DEFAULT_SIGNER_VAULT_JWT_LOGIN_URL)'
else
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/signer.DEFAULT_SIGNER_VAULT_JWT_LOGIN_URL=http://localhost:10000/v1/auth/jwt/login'
endif
...
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/signer.DEFAULT_SIGNER_VAULT_CA_URL=http://localhost:10000/v1/rootca/cert/ca_chain'
endif
...
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/signer.DEFAULT_SIGNER_VAULT_TTL=1h'
endif
