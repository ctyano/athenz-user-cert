...
ifneq ($(DEFAULT_ATHENZ_USER_PREFIX),)
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/certificate.DEFAULT_ATHENZ_USER_PREFIX=$(DEFAULT_ATHENZ_USER_PREFIX)'
else
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/certificate.DEFAULT_ATHENZ_USER_PREFIX=user.'
endif
