...
ifneq ($(DEFAULT_SIGNER_ZTS_EXTERNAL_ID_ENDPOINT),)
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/signer.DEFAULT_SIGNER_ZTS_EXTERNAL_ID_ENDPOINT=$(DEFAULT_SIGNER_ZTS_EXTERNAL_ID_ENDPOINT)'
else
LDFLAGS_ARGS += -X '$(APP_REPO_URL)/pkg/signer.DEFAULT_SIGNER_ZTS_EXTERNAL_ID_ENDPOINT=https://127.0.0.1:4443/zts/v1/extmembercert'
endif
