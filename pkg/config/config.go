...
func Load() (*Settings, error) {
	...
	return &Settings{
		...
		ExternalIDEndpoint: stringValue(values, ztsExternalIDEndpointKeys(), "ATHENZ_ZTS_EXTERNAL_ID_ENDPOINT"),
...
func applyPackageDefaults(values map[string]any) {
	...
	setString(values, &signer.DEFAULT_SIGNER_ZTS_EXTERNAL_ID_ENDPOINT, ztsExternalIDEndpointKeys(), "ATHENZ_ZTS_EXTERNAL_ID_ENDPOINT")
...
func ztsExternalIDEndpointKeys() []string {
	return []string{
		"zts.external_id_endpoint",
		"zts.external-id-endpoint",
		"signer.zts.external_id_endpoint",
		"signer.zts.external-id-endpoint",
	}
}
